...
3. 通过监听window的blur和focus事件，当离开视频播放页时，暂停播放或者静音等其他播放器事件。适用场景比如你正在边打游戏边看视频，你的游戏开始需要加载5分钟，或者英雄死了，复活要1分钟，你决定切回网页看视频，看到一半游戏窗口主动被激活到当前窗口，视频依旧播放，那你还需要再切回浏览器进行暂停操作，这个的确很繁琐。（当然大部分游戏不会主动激活到当前窗口，不过有的还是会的。）
